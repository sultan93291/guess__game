...
btn === null || btn === void 0 ? void 0 : btn.addEventListener("click", () => {
    if ((input === null || input === void 0 ? void 0 : input.value) !== "") {
        if (!isNaN(Number(input === null || input === void 0 ? void 0 : input.value))) {
            if (Number(input === null || input === void 0 ? void 0 : input.value) >= 0 && Number(input === null || input === void 0 ? void 0 : input.value) <= 10) {
                value = Number(input === null || input === void 0 ? void 0 : input.value);
                if (input) {
                    input.value = "";
                }
                if (player !== null) {
...
guess === null || guess === void 0 ? void 0 : guess.addEventListener("click", () => {
    if ((input === null || input === void 0 ? void 0 : input.value) !== "") {
        if (!isNaN(Number(input === null || input === void 0 ? void 0 : input.value))) {
            if (Number(input === null || input === void 0 ? void 0 : input.value) >= 0 && Number(input === null || input === void 0 ? void 0 : input.value) <= 10) {
                if (Number(input === null || input === void 0 ? void 0 : input.value) !== value && remainChance !== 0) {
                    remainChance--;
                    if (chance__remain) {
                        chance__remain.innerHTML = ` chance remain : ${remainChance}`;
                        if (player__error) {
                    ...
                    if (Number(input === null || input === void 0 ? void 0 : input.value) === value) {
                        if (img) {
                            img.src = "../images/winner.png";
                            if (input) {
                                input.style.display = "none";
